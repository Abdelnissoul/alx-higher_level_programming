...
class Rectangle:
    ...
    Attributes:
        ...
        print_symbol (any): The symbol used for string reprs.
    """
    ...
    def square(cls, size=0):
        """Return a new Rectangle default start with 0"""
        return (cls(size, size))

    def __str__(self):
        """Return the representation of the Rectangle.

        by printing the rectangle with the # character.
        """
        if self.__width == 0 or self.__height == 0:
            return ("")
